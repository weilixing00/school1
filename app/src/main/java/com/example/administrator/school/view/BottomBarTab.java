...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        // TODO: 2016/8/28  未选中的颜色
        mIcon.setColorFilter( ContextCompat.getColor(context, R.color.shadowGray));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.shadowGray));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.shadowGray));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.shadowGray));
        }
    }
